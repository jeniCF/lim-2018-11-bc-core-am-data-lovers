...
const lol = {
  ...
  data: {
    Aatrox: {
      ...
      blurb: 'Aatrox is a legendary warrior, one of only five that remain of an ancient race known as the Darkin. He wields his massive blade with grace and poise, slicing through legions in a style that is hypnotic to behold. With each foe felled...',
      info: {
        attack: 8,
        defense: 4,
        magic: 3,
    ...
    Alistar: {
      ...
      blurb: 'As the mightiest warrior to ever emerge from the Minotaur tribes of the Great Barrier, Alistar defended his tribe from Valorans many dangers; that is, until the coming of the Noxian army. Alistar was lured from his village by the machinations of ...',
      info: {
        attack: 6,
        defense: 9,
        magic: 5,
...
const inputFilter1 = [

  {
    ...
    blurb:
      'Aatrox is a legendary warrior, one of only five that remain of an ancient race known as the Darkin. He wields his massive blade with grace and poise, slicing through legions in a style that is hypnotic to behold. With each foe felled...',
    info: {
      attack: 8,
      defense: 4,
      magic: 3,
  ...
  },
  {
    ...
    blurb:
      'As the mightiest warrior to ever emerge from the Minotaur tribes of the Great Barrier, Alistar defended his tribe from Valorans many dangers; that is, until the coming of the Noxian army. Alistar was lured from his village by the machinations of ...',
    info: {
      attack: 6,
      defense: 9,
      magic: 5,
...
const inputFilter2 = ['Tank', 'Fighter'];
...
const inputSort1 = true;
const inputSort2 = false;
...
const ouputStatsHp = '707.80';

const outputStatsMp = '195.60';
...
describe('lol.filterChampions', () => {
  it('debería ser una función', () => {
    expect(typeof window.lol.filterChampions).toBe('function');
  });

  it('debería retornar un array de objetos, con el valor de la propiedad tag filtrado por tank y fighter', () => {
    expect(window.lol.filterChampions(inputFilter1, inputFilter2)).toEqual(output);
  });
});
describe('lol.sortFunction', () => {
  it('debería ser una función', () => {
    expect(typeof window.lol.sortFunction).toBe('function');
  });

  it('debería retornar un array de objetos ordenado de A-Z', () => {
    expect(window.lol.sortFunction(inputFilter1, inputSort1)).toEqual(inputFilter1);
  });

  it('debería retornar un array de objetos ordenado de Z-A', () => {
    expect(window.lol.sortFunction(inputFilter1, inputSort2)).toEqual(outputsort1);
  });
});

describe('lol.functionMaxMin', () => {
  it('debería ser una función', () => {
    expect(typeof window.lol.functionMaxMin).toBe('function');
  });

  it('debería retornar 707.80', () => {
    expect(window.lol.functionMaxMin(inputStats, 2, 0, 1)).toEqual(ouputStatsHp);
  });

  it('debería retornar 195.60', () => {
    expect(window.lol.functionMaxMin(inputStats, 2, 0, 2)).toEqual(outputStatsMp);
  });
